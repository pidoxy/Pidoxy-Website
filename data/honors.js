// Awards & honours. Facts are verified — amounts, placements, and counts
// must not change. `kind`: "win" → Hackathon Wins & Podiums column,
// "selection" → Grants, Scholarships & Selections column.
export const honors = [
  {
    kind: "win",
    date: "2026",
  ...
  },
  {
    kind: "win",
    date: "2022",
    title: "HackLab Nigeria — 1st Runner-Up",
  ...
  },
  {
    kind: "win",
    date: "2021",
    title: "HackZurich — Hybrid Team Award",
  ...
  },
  {
    kind: "selection",
    date: "2026",
    title: "African Computer Vision Summer School — Accepted with Full Grant",
    org: "ACVSS · Google AI Community Center, Accra",
    result: "1 of 31 from 312 applicants",
    detail:
      "Selected for the African Computer Vision Summer School — intensive lectures, mentoring, and research with 15+ scientists across advanced vision, diffusion, self-supervised, and multimodal learning.",
  ...
  },
  {
    ...
    org: "Jim Ovia Foundation · 2025–2027",
    result: "Scholar",
    detail: "National scholarship recognizing top performance in STEM.",
    link: "",
  },
  {
    kind: "selection",
  ...
  },
  {
    kind: "selection",
    date: "2024",
    title: "Squad Hackademy Undergraduate Scholarship",
    org: "Squad (GTCO) · 2024–2027",
    result: "Scholar",
    detail: "Scholarship recognizing top performance in programming.",
    link: "",
  },
  {
    kind: "selection",
  ...
  },
  {
    kind: "selection",
    date: "2022",
    title: "₦300,000 Innovation Grant — HackLab Nigeria",
    org: "HackLab Foundation · for PheraCam",
    result: "Grant",
    detail:
      "Awarded alongside the 1st runner-up finish: a ₦300k grant, two Nvidia Deep Learning Institute vouchers, and a video documentary by BlueAfric Media.",
    link: "https://www.instagram.com/p/CfWHkiZKEzP/",
  },
];
